...
import com.microservices.twitter.exceptions.TwitterServiceException;
...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    private final TwitterServiceConfigData twitterToKafkaServiceConfigData;
    ...
    public MockKafkaStreamRunner(TwitterServiceConfigData configData,
    ...
    private void sleep(long sleepTimeMs) {
        try {
            ...
            throw new TwitterServiceException("Error while sleeping for waiting new status to create!!");
        }
    }
